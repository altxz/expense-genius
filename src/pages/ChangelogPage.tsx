...
export const CHANGELOG: ChangelogEntry[] = [
  {
    id: '2026-05-04-invoice-modal-restructure',
    date: '04/05/2026',
    version: '2.13',
    title: 'Modal de Fatura Reestruturado',
    description: 'O modal de detalhes da fatura agora prioriza a lista de transações, com cabeçalho e rodapé compactos. Carteira e data de pagamento ficam lado a lado em um grid de 2 colunas para máximo aproveitamento da tela.',
    icon: <CreditCard className="h-5 w-5" />,
    tag: 'melhoria',
  },
  {
    id: '2026-05-04-calendar-popover-fix',
    date: '04/05/2026',
    version: '2.12',
    title: 'Correção do calendário de pagamento',
    description: 'Corrigido bug onde o calendário ao escolher data personalizada de pagamento empurrava os botões "Salvar" e "Pagar" para fora da tela. Agora o calendário flutua sobre a interface via Popover.',
    icon: <Calendar className="h-5 w-5" />,
    tag: 'correção',
  },
  {
    id: '2026-05-04-retroactive-duplicates',
    date: '04/05/2026',
    version: '2.11',
    title: 'Liberação de descrições repetidas em meses anteriores',
    description: 'Removido o bloqueio que impedia criar despesas com o mesmo nome de transações em meses passados. Agora você pode reutilizar descrições livremente entre períodos diferentes.',
    icon: <Repeat className="h-5 w-5" />,
    tag: 'melhoria',
  },
  {
    id: '2026-05-04-mobile-tuning',
    date: '04/05/2026',
    version: '2.10',
    title: 'Ajustes finos de mobile',
    description: 'Refinamentos em tipografia, áreas de toque, modais e densidade visual no mobile. Inputs com 16px para evitar zoom no iOS, modais com max-h 85dvh e utilitários de safe-area para iPhone.',
    icon: <Smartphone className="h-5 w-5" />,
    tag: 'melhoria',
  },
  {
    id: '2026-05-03-reconciliation-message',
    date: '03/05/2026',
    version: '2.9',
    title: 'Mensagem amigável de reconciliação',
    description: 'Quando a engine de reconciliação bloqueia uma inserção retroativa, agora exibimos uma mensagem clara orientando você a revisar a transação ao invés de mostrar erro técnico.',
